...
// app 本身有很多方法，其中包括最常用的 get、post、put/patch、delete，在这里我们调用其中的 get方法，
// 为我们的 `/` 路径指定一个 handler 函数。这个 handler 函数会接收 req 和 res 两个对象，
// 他们分别是请求的 request 和 response。request 中包含了浏览器传来的各种信息，
...
var server = app.listen(8083, function(){
	...
	console.log('app is listening at port', port, host);
})